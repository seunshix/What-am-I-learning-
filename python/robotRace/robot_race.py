...
# Add your code below!
num_colissions = Counter(move[0] for move in robot_moves if move[2] == True)
...
# Add your code below!
for bot in bots:
  bot_scores.append(BotScoreData(bot.name, num_moves, num_colissions, num_moves + num_colissions))
